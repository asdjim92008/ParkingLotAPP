...
function afterClick() {
    ...
    Searchbox.style['box-shadow'] = '0px 9px 20px';
    var title = document.querySelector('.title');
    title.style['transform'] = 'translateY(50px)';
};

document.getElementById("SearchCar").onblur = function () { beforeClick() };

function beforeClick() {
    var Searchbox = document.getElementById('search');
    var title = document.querySelector('.title');
    Searchbox.style['outline'] = 'none';
    Searchbox.style['box-shadow'] = '0px 8px 15px rgb(75 72 72 / 10%)';
    title.style['transform'] = 'translateY(-2000%)';
}

function SearchCar() {
    window.location = "/CheckCar/Index";
}
